...
from lib.chatterbot import utils
from lib.chatterbot.logic import LogicAdapter
from lib.chatterbot.search import IndexedTextSearch
from lib.chatterbot.storage import StorageAdapter
...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get(
            'storage_adapter', 'lib.chatterbot.storage.SQLStorageAdapter')
    ...
    def get_response(self, statement=None, **kwargs):
        ...
        input_statement = Statement(in_response_to=text, **kwargs)
