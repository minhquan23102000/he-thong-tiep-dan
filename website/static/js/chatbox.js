$(
  function () {
      ...
      $.get("/get-img", { tag: newtag }).done(function (data) {
        ...
        for (var i = 0; i < data.paper.length; i += 2) {
          ...
          for (var j = i; j < i + 2 && j < data.paper.length; j++) {
            ...
            str +=
              " alt='website template image' class='img-responsive'></img>";
            // Add caption
            str += "<figcaption> ";
    ...
    function generate_modal(index, data) {
      ...
      str += " <div class ='modal-body'> <img src = '" + data.src +
    ...
    function generate_next_questions(next_questions) {
      ...
      for (let index = 0; index < next_questions.length; index++) {
        str += "<div id='cm-msg-" + (INDEX + 1 + index) +
          "' class=\"next-msg " + type + '">';
      ...
      $("#cm-msg-" + INDEX + 1).hide().fadeIn(300);
      $("#cm-msg-" + INDEX + 2).hide().fadeIn(400);
      $("#cm-msg-" + INDEX + 3).hide().fadeIn(500);
      ...
      if (msg.trim()) {
        ...
        $.get("/get", { msg: msg, oldtag: oldtag }).done(function (data) {
          ...
          if (!checkAction(data.response)) {
            ...
            setTimeout(
              function () { generate_message(response, "user"); },
              1000);
            setTimeout(
              function () { generate_next_questions(next_questions); },
              1700);
    ...
    function get_conversation_id() {
      $.get("/get-conversation-id").done(function (data) { return data; });
    }
    ...
    function addButtonTokhai() {
      ...
      console.log(tag)
      var url = './to-khai/' + tag
      var html = '<div class="card-action"> <a href="' + url +
        '">ĐIỀN TỜ KHAI</a> </div>';
      $("#to-khai").append(html);
    }
    ...
    function activateTypingAnimation() {
      ...
      var html = `
          <div id="cm-msg-${INDEX+1}" class="chat-msg user" name="typing-animation">
