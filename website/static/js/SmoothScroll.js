...
!(function () {
  ...
  function m() {
    if (document.body) {
      ...
      if (
        ...
        j > i &&
        (a.offsetHeight <= i || e.offsetHeight <= i) &&
        ((e.style.height = "auto"),
        setTimeout(refresh, 10),
        g.offsetHeight <= i)
      ) {
        var k = document.createElement("div");
        (k.style.clear = "both"), a.appendChild(k);
      }
      b.fixedBackground ||
        c ||
    ...
    if (
      ...
      var i = a === document.body,
        j = function (f) {
          ...
          i
            ? window.scrollBy(h, k)
            : (h && (a.scrollLeft += h), k && (a.scrollTop += k)),
            c || d || (n = []),
            n.length ? F(j, a, e / b.frameRate + 1) : (o = !1);
        };
      F(j, a, 0), (o = !0);
    }
  }
  ...
  function s(a) {
    var c = a.target,
      d =
        ...
        a.altKey ||
        a.metaKey ||
        (a.shiftKey && a.keyCode !== k.spacebar);
    if (
      /input|textarea|select|embed/i.test(c.nodeName) ||
      c.isContentEditable ||
      a.defaultPrevented ||
      d
    )
  ...
  function y(a, b, c) {
    window.addEventListener(a, b, c || !1, {passive:false});
  }
  function z(a, b, c) {
  ...
  function H(a) {
    return a >= 1
      ...
      : a <= 0
      ? 0
      : (1 == b.pulseNormalize && (b.pulseNormalize /= G(1)), G(a));
  }
  var h,
    a = {
      frameRate: 150,
  ...
  J && I && (y("mousedown", t), y("mousewheel", r), y("load", m));
})();
