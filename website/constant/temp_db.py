...
paper_description = {
    'giấy tờ tùy thân': "Giấy tờ tùy thân có hiệu lực bao gồm, giấy CMND, căn cước công dân hoặc bất kì loại giấy tờ có hiệu lực pháp lý xác minh bản thân người làm giấy.",
    'sổ thường trú': "Là giấy tờ xác mình nơi cư trú. Các giấy tờ có hiệu lực bao gồm: giấy chứng nhận nhân khẩu tập thể, sổ tạm trú, sổ thường trú, sổ hộ khẩu.",
    ...
    'giấy chứng nhận kết hôn': "Giấy chứng nhận kết hôn là văn bản do cơ quan nhà nước có thẩm quyền cấp cho hai bên nam, nữ khi đăng ký kết hôn, nhằm xác lập mối quan hệ hôn nhân giữa hai người nam nữ.",
    ...
    'bản sao khai sinh': "Là bản sao giấy khai sinh. Bạn có thể nhận bản sao thông qua cơ quan đăng ký hộ tịch. Thông thường là Ủy ban nhân dân cấp xã (khi khai sinh không có yếu tố nước ngoài) hoặc Ủy ban nhân dân cấp huyện nơi bạn sinh ra (nếu khai sinh có yếu tố nước ngoài)."
}
...
def make_img_guide(tag):
    ...
    for di in paper[tag]:
        if not di['title'] == 'to_khai':
            di['description'] = paper_description[di['title']]
